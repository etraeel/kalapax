                ...
                <form class="form-horizontal" action="{{ route('admin.discount.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" disabled name="number_discount_fixed" id="number_discount_fixed"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" disabled name="max_discount_price" id="max_discount_price" class="form-control"
