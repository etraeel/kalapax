                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    <a href="{{ route('admin.orders.show' , $order->id) }}"
                                       class="btn btn-sm btn-warning  ml-1">مشاهده جزئیات سفارش</a>
                                    <a href="{{ route('admin.orders.payments' , $order->id) }}"
                                       class="btn btn-sm btn-info  ml-1">مشاهده پرداخت‌ها</a>
                                    @can('edit-order')
                                        <a href="{{ route('admin.orders.edit' , $order->id) }}"
                                           class="btn btn-sm btn-primary  ml-1">ویرایش سفارش</a>
                                    @endcan
