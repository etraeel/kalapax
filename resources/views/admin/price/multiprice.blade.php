                        ...
                        <div id="prices_item-{{ $loop->index }}">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control changeCurrency" onkeyup="format(this)" onmouseover="format(this)"
                ...
                <input type="number" class="form-control"
                       name="prices_item[${index}][inventory]" id="inventory"
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <label for="price">قیمت</label>
                                    <input type="text" class="form-control" onkeyup="format(this)"  onmouseover="format(this)"
